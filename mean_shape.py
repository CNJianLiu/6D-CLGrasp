...
parser.add_argument('--model', type=str, default='train_results/autoencoder/model.pth',  help='resume model')
parser.add_argument('--result_dir', type=str, default='train_results/mean_shape', help='directory to save mean shapes')
...
estimator = GSENet(opt.emb_dim, opt.n_pts)
estimator.cuda()
